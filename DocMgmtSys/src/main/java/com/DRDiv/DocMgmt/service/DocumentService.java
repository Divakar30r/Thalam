...
import com.DRDiv.DocMgmt.repository.Document.DocumentRepository;
import com.DRDiv.DocMgmt.service.mapper.DocumentMapper;
...
public class DocumentService {
    ...
    */
    ...
    // #result indicates return object, the return is saved here .. instead of actual input
    //@CachePut(cacheNames = "document_cache", key = "#result.id", condition = "#result.id != null")
    public DocumentDTO save(DocumentDTO documentDTO) {
        log.info("Request to save document {}", documentDTO);
        DocumentEntity document = documentMapper.documentDTOToDocument(documentDTO);
