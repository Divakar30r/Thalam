...
import com.DRDiv.DocMgmt.controller.advice.errors.InvalidPasswordException;
import com.DRDiv.DocMgmt.controller.advice.errors.UserNotFoundException;
...
import com.DRDiv.DocMgmt.repository.AppUser.AppUserRepository;
import com.DRDiv.DocMgmt.security.Jwt;
import com.DRDiv.DocMgmt.service.mapper.AppUserMapper;
...
public class AppUserService {
    ...
    */
    ...
    public AppUserDTO create(AppUserDTO appUserDTO) {
        ...
        AppUserEntity appUser = appUserMapper.appUserDTOToAppUser(appUserDTO);
    ...
    @Transactional(readOnly = true, transactionManager  = "DocMS_User_DB_Transaction_Manager_Factory")
